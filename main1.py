...
def compileFile():
    ...
    os.system("C:/Users/USER/Desktop/New_folder/Mini-Java-Compiler/app.exe < "+file_to_compile.name +" > C:/Users/USER/Desktop/New_folder/Mini-Java-Compiler/output.txt")
    output = open("C:/Users/USER/Desktop/New_folder/Mini-Java-Compiler/output.txt","r")
    terminal.delete(1.0, tk.END)
    with open("C:/Users/USER/Desktop/New_folder/Mini-Java-Compiler/output.txt", "r") as input_file:
        text = input_file.read()
